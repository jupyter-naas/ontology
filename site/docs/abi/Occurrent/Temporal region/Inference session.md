...
### Definition
A temporal region during which an AI model performs inference.
...
### URI
http://ontology.naas.ai/abi/InferenceSession

### Subclass Of
```mermaid
graph BT
    InferenceSession(Inference<br>session):::abi-->BFO_0000008
...
- [Inference session](/bfo/Occurrent/Temporal%20region/Inference%20session/Inference%20session.md)
