...
### Definition
A temporal region during which an AI model was trained.
...
### URI
http://ontology.naas.ai/abi/ModelTrainingPeriod

### Subclass Of
```mermaid
graph BT
    ModelTrainingPeriod(Model<br>training<br>period):::abi-->BFO_0000008
...
- [Model training period](/bfo/Occurrent/Temporal%20region/Model%20training%20period/Model%20training%20period.md)
