...
### Definition
A process in which an AI system generates text based on input.
...
### URI
http://ontology.naas.ai/abi/TextGenerationProcess

### Subclass Of
```mermaid
graph BT
    TextGenerationProcess(Text<br>generation<br>process):::abi-->BFO_0000015
...
- [Text generation process](/bfo/Occurrent/Process/Text%20generation%20process/Text%20generation%20process.md)
