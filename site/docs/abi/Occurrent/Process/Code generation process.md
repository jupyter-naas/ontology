...
### URI
http://ontology.naas.ai/abi/CodeGenerationProcess

### Subclass Of
```mermaid
graph BT
    CodeGenerationProcess(Code<br>generation<br>process):::abi-->BFO_0000015
...
- [Code generation process](/bfo/Occurrent/Process/Code%20generation%20process/Code%20generation%20process.md)
