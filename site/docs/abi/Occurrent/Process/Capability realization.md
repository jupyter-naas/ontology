...
### Definition
A process that realizes a specific capability.

### Examples
The process of generating text, analyzing data, or creating an image.

### Aliases
Not defined.

### URI
http://ontology.naas.ai/abi/capability/CapabilityRealization

### Subclass Of
```mermaid
graph BT
    CapabilityRealization(Capability<br>realization):::abi-->BFO_0000015
...
- [Capability realization](/bfo/Occurrent/Process/Capability%20realization/Capability%20realization.md)
...
| abi | [realizes capability](http://ontology.naas.ai/abi/capability/realizesCapability) | A relation between a capability realization process and the capability it realizes. |  | [Capability Realization](/bfo/Occurrent/Process/Capability%20realization/Capability%20realization.md) | [Capability](/bfo/Continuant/Specifically%20dependent%20continuant/Realizable%20entity/Capability/Capability.md) | - |
