...
### Definition
A process in which an AI system analyzes and interprets images.
...
### URI
http://ontology.naas.ai/abi/ImageAnalysisProcess

### Subclass Of
```mermaid
graph BT
    ImageAnalysisProcess(Image<br>analysis<br>process):::abi-->BFO_0000015
...
- [Image analysis process](/bfo/Occurrent/Process/Image%20analysis%20process/Image%20analysis%20process.md)
