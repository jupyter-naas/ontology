...
### Definition
Planned act in which two or more organizations or individuals enter into an agreement to cooperate for mutual benefit, typically to achieve shared objectives.

### Examples
A business partnership between two consulting firms

### Aliases
Not defined.

### URI
http://ontology.naas.ai/abi/ActOfPartnership

### Subclass Of
```mermaid
graph BT
    ActOfPartnership(Act<br>of<br>partnership):::abi-->ont00000228
...
- [Act of partnership](/bfo/Occurrent/Process/Act/Planned%20act/Act%20of%20partnership/Act%20of%20partnership.md)
