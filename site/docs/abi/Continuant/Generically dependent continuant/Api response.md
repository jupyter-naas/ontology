...
### Definition
An information content entity that contains AI system output.
...
### URI
http://ontology.naas.ai/abi/APIResponse

### Subclass Of
```mermaid
graph BT
    APIResponse(Api<br>response):::abi-->BFO_0000031
...
- [Api response](/bfo/Continuant/Generically%20dependent%20continuant/Api%20response/Api%20response.md)
