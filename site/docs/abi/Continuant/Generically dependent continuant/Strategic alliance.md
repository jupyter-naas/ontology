...
### Definition
Describes an agreement between two or more organizations to pursue a set of agreed-upon objectives while remaining independent entities.

### Examples
- A memorandum of understanding (MOU) between a technology company and a software provider
- A strategic collaboration agreement in the automotive sector

### Aliases
Not defined.

### URI
http://ontology.naas.ai/abi/StrategicAlliance
