...
### Definition
An information content entity that describes AI model parameters and capabilities.
...
### URI
http://ontology.naas.ai/abi/ModelSpecification

### Subclass Of
```mermaid
graph BT
    ModelSpecification(Model<br>specification):::abi-->BFO_0000031
...
- [Model specification](/bfo/Continuant/Generically%20dependent%20continuant/Model%20specification/Model%20specification.md)
