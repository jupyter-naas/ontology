...
### Definition
An information content entity that contains data used to train an AI model.
...
### URI
http://ontology.naas.ai/abi/TrainingDataset

### Subclass Of
```mermaid
graph BT
    TrainingDataset(Training<br>dataset):::abi-->BFO_0000031
...
- [Training dataset](/bfo/Continuant/Generically%20dependent%20continuant/Training%20dataset/Training%20dataset.md)
