...
### Definition
A quality that inheres in an AI system and represents response time.
...
### URI
http://ontology.naas.ai/abi/ResponseLatency

### Subclass Of
```mermaid
graph BT
    ResponseLatency(Response<br>latency):::abi-->BFO_0000019
...
- [Response latency](/docs/ontology/reference/full/Entity/Continuant/Specifically%20dependent%20continuant/Quality/Response%20latency/Response%20latency.md)
