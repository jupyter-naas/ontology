...
### Definition
A quality that inheres in an AI model and represents maximum token processing capacity.
...
### URI
http://ontology.naas.ai/abi/TokenCapacity

### Subclass Of
```mermaid
graph BT
    TokenCapacity(Token<br>capacity):::abi-->BFO_0000019
...
- [Token capacity](/docs/ontology/reference/full/Entity/Continuant/Specifically%20dependent%20continuant/Quality/Token%20capacity/Token%20capacity.md)
