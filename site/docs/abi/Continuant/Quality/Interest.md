...
### Definition
A quality of an organism or group of organisms indicating stake in the realization of certain capabilities.

### Examples
A user's interest in text generation, an organization's interest in data analysis.

### Aliases
Not defined.

### URI
http://ontology.naas.ai/abi/capability/Interest

### Subclass Of
```mermaid
graph BT
    Interest(Interest):::abi-->BFO_0000019
...
- [Quality](/docs/ontology/reference/full/Entity/Continuant/Specifically%20dependent%20continuant/Quality/Quality.md)
- [Interest](/docs/ontology/reference/full/Entity/Continuant/Specifically%20dependent%20continuant/Quality/Interest/Interest.md)
...
| abi | [interest strength](http://ontology.naas.ai/abi/capability/interestStrength) | The strength of interest in a capability realization. |  | [Interest](/docs/ontology/reference/full/Entity/Continuant/Specifically%20dependent%20continuant/Quality/Interest/Interest.md) | [decimal](http://www.w3.org/2001/XMLSchema#decimal) |
...
| cco | [quality of aggregate](https://www.commoncoreontologies.org/ont00001947) | x quality_of_aggregate y iff y is an instance of Object Aggregate and x is an instance of Quality, and x inheres_in_aggregate y. |  | [quality](/docs/ontology/reference/full/Entity/Continuant/Specifically%20dependent%20continuant/Quality/Quality.md) | [object aggregate](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Object%20aggregate/Object%20aggregate.md) | - |
| abi | [bearer of interest](http://ontology.naas.ai/abi/capability/bearerOfInterest) | A relation between an interest and the organism or group that bears it. |  | [Interest](/docs/ontology/reference/full/Entity/Continuant/Specifically%20dependent%20continuant/Quality/Interest/Interest.md) | [material entity](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Material%20entity.md) | - |
| abi | [has interest in](http://ontology.naas.ai/abi/capability/hasInterestIn) | A relation between an interest and the capability it concerns. |  | [Interest](/docs/ontology/reference/full/Entity/Continuant/Specifically%20dependent%20continuant/Quality/Interest/Interest.md) | [Capability](/docs/ontology/reference/full/Entity/Continuant/Specifically%20dependent%20continuant/Realizable%20entity/Capability/Capability.md) | - |
