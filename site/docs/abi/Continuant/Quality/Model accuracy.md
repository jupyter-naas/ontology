...
### Definition
A quality that inheres in an AI model and represents its performance accuracy.
...
### URI
http://ontology.naas.ai/abi/ModelAccuracy

### Subclass Of
```mermaid
graph BT
    ModelAccuracy(Model<br>accuracy):::abi-->BFO_0000019
...
- [Model accuracy](/docs/ontology/reference/full/Entity/Continuant/Specifically%20dependent%20continuant/Quality/Model%20accuracy/Model%20accuracy.md)
