...
### Definition
A material entity that distributes workload across multiple AI agents to optimize performance.

### Examples
Round-robin load balancer, weighted load balancer, intelligent routing system.

### Aliases
Not defined.

### URI
http://ontology.naas.ai/abi/LoadBalancer

### Subclass Of
```mermaid
graph BT
    LoadBalancer(Load<br>balancer):::abi-->BFO_0000040
...
- [Load balancer](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Load%20balancer/Load%20balancer.md)
