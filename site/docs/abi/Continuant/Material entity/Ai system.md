...
### Definition
A material entity that implements artificial intelligence capabilities.

### Examples
ChatGPT server infrastructure, Claude API endpoints, Gemini model instances.

### Aliases
Not defined.

### URI
http://ontology.naas.ai/abi/AISystem
