...
### Definition
A material entity that is a specific instantiation of an AI model running on hardware.

### Examples
GPT-4 model running on OpenAI's servers, Claude-3-Sonnet instance.

### Aliases
Not defined.

### URI
http://ontology.naas.ai/abi/AIModelInstance

### Subclass Of
```mermaid
graph BT
    AIModelInstance(Ai<br>model<br>instance):::abi-->AISystem
    AISystem(Ai<br>system):::abi-->BFO_0000040
...
- [Ai system](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Ai%20system/Ai%20system.md)
- [Ai model instance](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Ai%20system/Ai%20model%20instance/Ai%20model%20instance.md)
...
| abi | [has AI agent](http://ontology.naas.ai/abi/hasAIAgent) | A relation between an AI system and the AI agent it implements. |  | [AI System](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Ai%20system/Ai%20system.md) | [AI Agent](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Agent/Ai%20agent/Ai%20agent.md) | [is AI agent of](http://ontology.naas.ai/abi/isAIAgentOf) |
| abi | [has load balancer](http://ontology.naas.ai/abi/hasLoadBalancer) | A relation between an AI system and its load balancing component. |  | [AI System](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Ai%20system/Ai%20system.md) | [Load Balancer](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Load%20balancer/Load%20balancer.md) | - |
| abi | [has subsystem](http://ontology.naas.ai/abi/hasSubsystem) | A relation between AI systems where one system contains other systems as components. |  | [AI System](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Ai%20system/Ai%20system.md) | [AI System](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Ai%20system/Ai%20system.md) | [is subsystem of](http://ontology.naas.ai/abi/isSubsystemOf) |
| abi | [is subsystem of](http://ontology.naas.ai/abi/isSubsystemOf) | A relation between AI systems where one system is a component of another larger system. |  | [AI System](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Ai%20system/Ai%20system.md) | [AI System](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Ai%20system/Ai%20system.md) | - |
