...
### Definition
A spatial region defined by cloud service provider infrastructure.
...
### URI
http://ontology.naas.ai/abi/CloudRegion

### Subclass Of
```mermaid
graph BT
    CloudRegion(Cloud<br>region):::abi-->BFO_0000006
...
- [Cloud region](/bfo/Continuant/Independent%20continuant/Immaterial%20entity/Spatial%20region/Cloud%20region/Cloud%20region.md)
