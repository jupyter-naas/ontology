...
### Definition
Intangible activities or benefits provided by one party to another, often to solve a problem or meet a need.

### Examples
A software service, a physical service, a service, etc.

### Aliases
Not defined.

### URI
http://ontology.naas.ai/abi/Service

### Subclass Of
```mermaid
graph BT
    Service(Service):::abi-->Offering
...
- [Service](/docs/ontology/reference/full/Entity/Continuant/Specifically%20dependent%20continuant/Realizable%20entity/Disposition/Offering/Service/Service.md)
