...
### Definition
A disposition in whose realization some organism or group of organisms has or had an interest.

### Examples
A car's capability to ferry passengers, an AI's capability to generate text, a screwdriver's capability to open paint cans.

### Aliases
Not defined.

### URI
http://ontology.naas.ai/abi/capability/Capability

### Subclass Of
```mermaid
graph BT
    Capability(Capability):::abi-->BFO_0000017
...
- [Capability](/docs/ontology/reference/full/Entity/Continuant/Specifically%20dependent%20continuant/Realizable%20entity/Capability/Capability.md)
...
| abi | [capability description](http://ontology.naas.ai/abi/capability/capabilityDescription) | A description of what the capability enables. |  | [Capability](/docs/ontology/reference/full/Entity/Continuant/Specifically%20dependent%20continuant/Realizable%20entity/Capability/Capability.md) | [string](http://www.w3.org/2001/XMLSchema#string) |
| abi | [capability name](http://ontology.naas.ai/abi/capability/capabilityName) | The name or identifier of a capability. |  | [Capability](/docs/ontology/reference/full/Entity/Continuant/Specifically%20dependent%20continuant/Realizable%20entity/Capability/Capability.md) | [string](http://www.w3.org/2001/XMLSchema#string) |
