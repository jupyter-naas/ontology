...
### Definition
Tangible items that are created, manufactured, or sourced to satisfy a want or need.

### Examples
A software product, a physical product, a service, etc.

### Aliases
Not defined.

### URI
http://ontology.naas.ai/abi/Product

### Subclass Of
```mermaid
graph BT
    Product(Product):::abi-->Offering
...
- [Product](/docs/ontology/reference/full/Entity/Continuant/Specifically%20dependent%20continuant/Realizable%20entity/Disposition/Offering/Product/Product.md)
