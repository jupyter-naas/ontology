...
### Definition
A realizable entity that defines the specialized function or role of an AI agent within a system.

### Examples
Primary responder, fallback handler, specialized task executor, coordinator, validator.

### Aliases
Not defined.

### URI
http://ontology.naas.ai/abi/AgentRole

### Subclass Of
```mermaid
graph BT
    AgentRole(Agent<br>role):::abi-->BFO_0000017
...
- [Agent role](/docs/ontology/reference/full/Entity/Continuant/Specifically%20dependent%20continuant/Realizable%20entity/Agent%20role/Agent%20role.md)
