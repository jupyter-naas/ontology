...
```mermaid
graph BT
    ont00000710(Command<br>post<br>facility):::cco-->ont00001052
...
- [Command post facility](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Material%20artifact/Facility/Military%20facility/Command%20post%20facility/Command%20post%20facility.md)
