...
```mermaid
graph BT
    ont00001242(Actuator):::cco-->ont00000736
...
- [Actuator](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Material%20artifact/Transducer/Actuator/Actuator.md)
