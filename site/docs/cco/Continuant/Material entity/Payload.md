...
```mermaid
graph BT
    ont00000556(Payload):::cco-->BFO_0000040
...
- [Payload](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Payload/Payload.md)
