...
```mermaid
graph BT
    ont00000277(Nuclear<br>weapon):::cco-->ont00000445
...
- [Nuclear weapon](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Material%20artifact/Weapon/Nuclear%20weapon/Nuclear%20weapon.md)
