...
```mermaid
graph BT
    ont00000040(Grocery<br>store):::cco-->ont00001102
...
- [Grocery store](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Material%20artifact/Facility/Commercial%20facility/Grocery%20store/Grocery%20store.md)
