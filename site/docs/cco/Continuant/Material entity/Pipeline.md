...
```mermaid
graph BT
    ont00000867(Pipeline):::cco-->ont00000677
...
- [Pipeline](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Material%20artifact/Facility/Product%20transport%20facility/Pipeline/Pipeline.md)
