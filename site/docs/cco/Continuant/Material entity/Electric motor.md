...
```mermaid
graph BT
    ont00000952(Electric<br>motor):::cco-->ont00000210
...
- [Electric motor](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Material%20artifact/Engine/Electric%20motor/Electric%20motor.md)
