...
```mermaid
graph BT
    ont00000243(Heat<br>sink):::cco-->ont00000995
...
- [Heat sink](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Material%20artifact/Heat%20sink/Heat%20sink.md)
