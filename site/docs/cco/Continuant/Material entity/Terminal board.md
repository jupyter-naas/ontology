...
```mermaid
graph BT
    ont00000706(Terminal<br>board):::cco-->ont00000995
...
- [Terminal board](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Material%20artifact/Terminal%20board/Terminal%20board.md)
