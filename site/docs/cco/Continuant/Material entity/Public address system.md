...
```mermaid
graph BT
    ont00001265(Public<br>address<br>system):::cco-->ont00001036
...
- [Public address system](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Material%20artifact/Communication%20system/Public%20address%20system/Public%20address%20system.md)
