...
```mermaid
graph BT
    ont00000021(Sensor<br>platform):::cco-->ont00000995
...
- [Sensor platform](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Material%20artifact/Sensor%20platform/Sensor%20platform.md)
