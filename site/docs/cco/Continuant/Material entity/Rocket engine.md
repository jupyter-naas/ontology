...
```mermaid
graph BT
    ont00000362(Rocket<br>engine):::cco-->ont00000533
...
- [Rocket engine](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Material%20artifact/Engine/Reaction%20engine/Jet%20engine/Rocket%20engine/Rocket%20engine.md)
