...
```mermaid
graph BT
    ont00000348(Filter):::cco-->ont00000995
...
- [Filter](/docs/ontology/reference/full/Entity/Continuant/Independent%20continuant/Material%20entity/Material%20artifact/Filter/Filter.md)
