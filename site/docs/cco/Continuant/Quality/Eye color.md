...
```mermaid
graph BT
    ont00000044(Eye<br>color):::cco-->BFO_0000019
...
- [Eye color](/docs/ontology/reference/full/Entity/Continuant/Specifically%20dependent%20continuant/Quality/Eye%20color/Eye%20color.md)
