...
```mermaid
graph BT
    ont00000377(Disability):::cco-->BFO_0000019
...
- [Disability](/docs/ontology/reference/full/Entity/Continuant/Specifically%20dependent%20continuant/Quality/Disability/Disability.md)
