...
### URI
https://www.commoncoreontologies.org/ont00000327

### Subclass Of
```mermaid
graph BT
    ont00000327(Texture):::cco-->BFO_0000019
...
- [Texture](/docs/ontology/reference/full/Entity/Continuant/Specifically%20dependent%20continuant/Quality/Texture/Texture.md)
