...
```mermaid
graph BT
    ont00000026(Hair<br>color):::cco-->BFO_0000019
...
- [Hair color](/docs/ontology/reference/full/Entity/Continuant/Specifically%20dependent%20continuant/Quality/Hair%20color/Hair%20color.md)
