  ...
  themeConfig:
    ...
    ({
      ...
      metadata: [
        ...
        {name: 'twitter:image', content: 'https://ontology.naas.ai/img/landing-screensaver.gif'},
        {property: 'og:image', content: 'https://ontology.naas.ai/img/landing-screensaver.gif'},
